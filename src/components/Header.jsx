...
const Header = ({ onSearch }) => {
    ...
    return (
        ...
        <div className="header-container">
          <Link to="/goit-react-hw-05-movies" className="nav-logo film" target="">
          ...
          <nav className="nav-bar">
            <ul className="nav-menu">
              <li className="nav nav-menu-list home">
                <Link to="/goit-react-hw-05-movies" className={`nav-list-link home ${isMoviesPage == true ? '': 'active'}`}> HOME </Link>
              </li>
